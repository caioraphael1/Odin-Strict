...
syscall_ioctl :: #force_inline proc(fd: c.int, request: u32, arg: rawptr) -> c.int {
...
syscall_sysctl :: #force_inline proc(name: [^]c.int, namelen: c.size_t, oldp: rawptr, oldlenp: ^c.size_t, newp: rawptr, newlen: c.size_t) -> c.int {
...
syscall_sysctlbyname :: #force_inline proc(name: string, oldp: rawptr, oldlenp: ^c.size_t, newp: rawptr, newlen: c.size_t) -> c.int {
