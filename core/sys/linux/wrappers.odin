...
*/
dirent_iterate_buf :: proc(buf: []u8, offs: ^int) -> (d: ^Dirent, cont: bool) {
...
- A name of the entry
*/
dirent_name :: proc(dirent: ^Dirent) -> string #no_bounds_check {
	str := ([^]u8)(&dirent.name)
...
futex_op :: proc(arg_op: Futex_Arg_Op, cmp_op: Futex_Cmp_Op, op_arg: u32, cmp_arg: u32) -> u32 {
...
perf_cache_config :: #force_inline proc(id: Perf_Hardware_Cache_Id,
