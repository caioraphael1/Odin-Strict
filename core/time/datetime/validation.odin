...
*/
is_leap_year :: proc(#any_int year: i64) -> (leap: bool) {
...
*/
validate_year_month_day :: proc(#any_int year, #any_int month, #any_int day: i64) -> (err: Error) {
...
*/
validate_hour_minute_second :: proc(#any_int hour, #any_int minute, #any_int second, #any_int nano: i64) -> (err: Error) {
	if hour < 0 || hour > 23 {
		return .Invalid_Hour
	}
